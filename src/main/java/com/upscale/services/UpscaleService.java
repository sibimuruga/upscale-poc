...
public String processRequest(MultipartFile file)throws IOException, CsvException {
    ...
    return new Gson().toJson(doBusinessLogic(models));
}

    private List<Output> doBusinessLogic(List<Input> list) {
        List<Output> outputList = new ArrayList<>();
        List<POSTINGConfiguration> conf = configurationRepository.getByclientName("UPSCALE");
